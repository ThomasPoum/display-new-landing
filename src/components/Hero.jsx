    ...
    <Container className="pb-20 pt-10 text-center lg:pb-24 lg:pt-12">
      ...
      Répondez aux{' '}
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">succès</span><span class="text-slate-900"></span>
        </span>{' '}
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Laissez notre plateforme SaaS transformer vos réponses aux appels d’offre de transport public en tâches <span class="font-semibold ">simples</span>, <span class="font-semibold ">rapides</span> et <span class="font-semibold ">efficaces</span>.
      </p>
