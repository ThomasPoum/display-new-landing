...
export function Pricing() {
  ...
  <div className="md:text-center">
    ...
    <p className="mt-4 text-lg text-slate-400">
      De la TPE au grand groupe, nous avons l’offre qui vous correspond.
    </p>
  </div>
  <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
    ...
    <Plan
      ...
      features={[
        ...
        'Assistance par chat ou téléphone',
      ]}
    />
    <Plan
      name="Enterprise"
      price="Personnalisé"
      description="Une offre sur mesure pour vos besoins spécifiques."
      href="/register"
      features={[
        'Utilisateurs illimités',
        'Travail collaboratif sur les plannings',
        'Appels d’offre illimités',
        'Parc de véhicules illimité',
        'Nombre de conducteurs illimité',
        'Statistiques et exportation de données',
